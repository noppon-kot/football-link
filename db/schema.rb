...
ActiveRecord::Schema[7.2].define(version: 2026_01_31_073434) do
  ...
  create_table "matches", force: :cascade do |t|
    ...
    t.integer "pitch_no", default: 1, null: false
    t.string "video_url"
    t.index ["away_team_id"], name: "index_matches_on_away_team_id"
    t.index ["group_id"], name: "index_matches_on_group_id"
    t.index ["home_team_id"], name: "index_matches_on_home_team_id"
    t.index ["pitch_no"], name: "index_matches_on_pitch_no"
  ...
  add_foreign_key "standings_snapshots", "groups", on_delete: :cascade
